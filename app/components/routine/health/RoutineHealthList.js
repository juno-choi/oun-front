    ...
    return (
        <div>
            ...
            {healthList.map((health) => (
                <div onClick={() => handleClick(health.health_id)} className="relative px-10 py-6 text-white bg-black rounded-lg hover:bg-gray-900 cursor-pointer transition-colors duration-200 ease-in-out w-80 mb-4" key={health.health_id}>
