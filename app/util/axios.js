...
api.interceptors.request.use(async (config) => {
    ...
    if (!accessToken) {
        ...
        // cookie에 저장
        document.cookie = `access_token=${newAccessToken}; max-age=${newAccessTokenExpiry}; path=/; Secure; SameSite=Lax`;
        document.cookie = `refresh_token=${newRefreshToken}; max-age=${newRefreshTokenExpiry}; path=/; Secure; SameSite=Lax`;
    }
